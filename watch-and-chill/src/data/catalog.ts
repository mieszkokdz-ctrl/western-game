...
export const catalog: Title[] = [
  ...
  {
    id: 'food-chef',
    title: 'W kuchni szefa',
    author: '@kuchniazpasja',
    category: 'Jedzenie',
    caption: 'Tak powstaje danie dnia 👨‍🍳🔥 #chef #gotowanie',
    likes: 73200,
    comments: 1230,
    shares: 480,
    poster: 'https://picsum.photos/seed/wc-food-chef/400/700',
    videoUrl: `${PIXABAY}/2022/11/14/139055-771618616_large.mp4`,
  },
  ...
  // --- Podróże ---
  {
    ...
    author: '@offtrail',
    category: 'Podróże',
    caption: 'Nowa droga, nowa przygoda 🚗🗺️ #roadtrip #podroze',
    likes: 132700,
    comments: 2190,
    shares: 1340,
    poster: 'https://picsum.photos/seed/wc-travel-road/400/700',
    videoUrl: `${PIXABAY}/2024/03/25/205589-927335742_large.mp4`,
  },

  // --- Zwierzęta ---
  {
    id: 'animals-puppy',
    title: 'Wierny towarzysz',
    author: '@zwierzakitv',
    category: 'Zwierzęta',
    caption: 'Ten wzrok rozczula za każdym razem 🐶🥹 #pies #zwierzeta',
    likes: 287400,
    comments: 5920,
    shares: 3870,
    poster: 'https://picsum.photos/seed/wc-animals-puppy/400/700',
    videoUrl: `${PIXABAY}/2024/07/24/222837_large.mp4`,
  },
